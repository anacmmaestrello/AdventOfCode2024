...
public class ResonantCollinearity {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Part 1: Calculate antipodes (marking adjacent points in rows/columns)
            System.out.println("Part 1: Total antipodes = " + sumAntipodes(1));
    ...
    // Method to mark the antipodes (based on part 1 logic)
    private static void markPodes(int y, int x, int dy, int dx, int[][] antipodes) {
        // Part 1: Mark directly adjacent points (rows/columns)
        if (inbounds(y + dy, x + dx)) {
            antipodes[y + dy][x + dx] = 1;
        }
    }
